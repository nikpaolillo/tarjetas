                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li>
                                <a href="{{ route('admin') }}"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                            </li>
                            <li>
                                <a href="{{ route('equipos.index') }}"><i class="fa fa-edit"></i> Equipos <span class="fa fa-chevron-down"></span></a>
                            </li>
                            <li>
                                <a href="{{ route('modelos.index') }}"><i class="fa fa-edit"></i> Modelos <span class="fa fa-chevron-down"></span></a>
                            </li>
                        </ul>
                    </div>
